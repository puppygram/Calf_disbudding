...
disbud.dat <-
  ...
  mutate(
    Treatment = ifelse(Treatment == "D", "T-CD-T", 
                       ifelse(Treatment == "L", "LA-CD", 
...
cortisol.dat <- 
  ...
  mutate(Treatment.L = ifelse(Treatment == "LA-CD", 1, 0)) %>%
  mutate(Treatment.T = ifelse(Treatment == "T-CD-T", 1, 0)) %>%
...
behavior.dat.post <- 
  left_join(
    behavior.dat, 
    behavior.dat.baseline %>% 
      dplyr::select(c(ID:TransitionsBaseline)), 
...
#make rank ordinal
behavior.dat.post$Rank <- ordered(behavior.dat.post$Rank, levels = 1:4, labels = c("comfortable", "slightly uncomfortable", "uncomfortable", "very uncomfortable"))
```

# Cortisol
```{r}
#percent of missing obs
nrow(filter(cortisol.dat, is.na(Cortisol))) / nrow(cortisol.dat) 
...
Fvalues.baseline <- lapply(analysis, function(x) {
  Anova(model.cortisol.post$ana[[x]])[2,3]})
Fvalues.baseline <- as.data.frame(Fvalues.baseline)
miceadds::micombine.F(Fvalues.baseline, 1)


Fvalues.treatment <- lapply(analysis, function(x) {
  Anova(model.cortisol.post$ana[[x]])[3,3]})
Fvalues.treatment <- as.data.frame(Fvalues.treatment)
miceadds::micombine.F(Fvalues.treatment, 2)


Fvalues.time <- lapply(analysis, function(x) {
  Anova(model.cortisol.post$ana[[x]])[4,3]})
Fvalues.time <- as.data.frame(Fvalues.time)
miceadds::micombine.F(Fvalues.time, 5)


Fvalues.interaction <- lapply(analysis, function(x) {
  Anova(model.cortisol.post$ana[[x]])[5,3]})
Fvalues.interaction <- as.data.frame(Fvalues.interaction)
miceadds::micombine.F(Fvalues.interaction, 10)
...
ggplot(data = predict.cortisol, 
  ...
  ggsave("figure_cortisol.png", width = 9.5, height = 5)
}
```
...
#percent of missing obs
{
  nrow(filter(disbud.dat, is.na(Burn_time)))/ nrow(disbud.dat) 
  nrow(filter(disbud.dat, is.na(Handle_time)))/ nrow(disbud.dat) 
  (nrow(filter(disbud.dat, is.na(Tail_wag))) + nrow(filter(disbud.dat, is.na(Handle_time))))/ (nrow(disbud.dat) + nrow(disbud.dat))
  (nrow(filter(disbud.dat, is.na(Head_movement))) + nrow(filter(disbud.dat, is.na(Handle_time))))/ (nrow(disbud.dat) + nrow(disbud.dat))
  (nrow(filter(disbud.dat, is.na(Force))) + nrow(filter(disbud.dat, is.na(Handle_time))))/ (nrow(disbud.dat) + nrow(disbud.dat))
  (nrow(filter(disbud.dat, is.na(Rear))) + nrow(filter(disbud.dat, is.na(Handle_time))))/ (nrow(disbud.dat) + nrow(disbud.dat))
}
...
meth = mice(disbud.dat, seed = 1, maxit = 0)$method
{
  ...
  meth[c("Tail_wag", "Head_avoidance", "Head_stretch", "Head_movement", "Force", "Kick")] = "poisson"
...
#means separation
multcomp::cld(lsmeans, alpha = .08)

confint(contrast(regrid(lsmeans), ratio = F, method = "pairwise"))
contrast(emmeans(model.burnTime, ~ Treatment), ratio = F, method = "pairwise")
```
...
##lsmeans
lsmeans <- emmeans(model.handleTime, ~ Treatment)
lsmeans

lsmeans2 <- emmeans(model.handleTime, ~ 1)
lsmeans2
```
...
testZeroInflation(simulationOutput, alternative = "greater")
...
simulationOutput <- simulateResiduals(model.head$ana[[15]])
testDispersion(simulationOutput, plot = F, alternative = "greater")
testZeroInflation(simulationOutput, plot = F, alternative = "greater")

#pooled F-tests
chiSqvalues.treatment <- lapply(analysis, function(x) {
  Anova(model.head$ana[[x]], test.statistic = "Chisq")[1,1]})
miceadds::micombine.chisquare(as.data.frame(chiSqvalues.treatment), 2)
...
simulationOutput <- simulateResiduals(model.force$ana[[25]])
testDispersion(simulationOutput, plot = F, alternative = "greater")
testZeroInflation(simulationOutput, alternative = "greater")

#pooled F-tests
chiSqvalues.treatment <- lapply(analysis, function(x) {
  car::Anova(model.force$ana[[x]], test.statistic = "Chisq")[1,1]})
Fvalues.treatment <- as.data.frame(chiSqvalues.treatment)
miceadds::micombine.chisquare(chiSqvalues.treatment, 2)
...
#tincture
tincture.mean <- lapply(analysis, function(x) {
  describe.vocal[["analyses"]][[x]][["T-CD-T"]][["median"]]})
mean(as.data.frame(tincture.mean))

tincture.sd <- lapply(analysis, function(x) {
  describe.vocal[["analyses"]][[x]][["T-CD-T"]][["se"]]})
mean(as.data.frame(tincture.sd))


#lidocaine
lidocaine.mean <- lapply(analysis, function(x) {
  describe.vocal[["analyses"]][[x]][["LA-CD"]][["mean"]]})
mean(as.data.frame(lidocaine.mean))

lidocaine.sd <- lapply(analysis, function(x) {
  describe.vocal[["analyses"]][[x]][["LA-CD"]][["se"]]})
mean(as.data.frame(lidocaine.sd))


#sham
sham.mean <- lapply(analysis, function(x) {
  describe.vocal[["analyses"]][[x]][["SD"]][["mean"]]})
mean(as.data.frame(sham.mean))

sham.sd <- lapply(analysis, function(x) {
  describe.vocal[["analyses"]][[x]][["SD"]][["se"]]})
mean(as.data.frame(sham.sd))
```
...
{
  (nrow(filter(behavior.dat.post, is.na(Jerk))) + nrow(filter(behavior.dat.baseline, is.na(JerkBaseline))))/ (nrow(behavior.dat.post) + nrow(behavior.dat.baseline))
  (nrow(filter(behavior.dat.post, is.na(Shake))) + nrow(filter(behavior.dat.baseline, is.na(ShakeBaseline))))/ (nrow(behavior.dat.post) + nrow(behavior.dat.baseline))
  (nrow(filter(behavior.dat.post, is.na(Rub))) + nrow(filter(behavior.dat.baseline, is.na(RubBaseline))))/ (nrow(behavior.dat.post) + nrow(behavior.dat.baseline))
  (nrow(filter(behavior.dat.post, is.na(Hoof_rub))) + nrow(filter(behavior.dat.baseline, is.na(Hoof_rubBaseline))))/ (nrow(behavior.dat.post) + nrow(behavior.dat.baseline))
  (nrow(filter(behavior.dat.post, is.na(Ear))) + nrow(filter(behavior.dat.baseline, is.na(EarBaseline))))/ (nrow(behavior.dat.post) + nrow(behavior.dat.baseline))
  (nrow(filter(behavior.dat.post, is.na(Up_sec))) + nrow(filter(behavior.dat.baseline, is.na(Up_secBaseline))))/ (nrow(behavior.dat.post) + nrow(behavior.dat.baseline))
  (nrow(filter(behavior.dat.post, is.na(Oral))) + nrow(filter(behavior.dat.baseline, is.na(OralBaseline))))/ (nrow(behavior.dat.post) + nrow(behavior.dat.baseline))
  (nrow(filter(behavior.dat.post, is.na(Rum_sec))) + nrow(filter(behavior.dat.baseline, is.na(Rum_secBaseline))))/ (nrow(behavior.dat.post) + nrow(behavior.dat.baseline))
  (nrow(filter(behavior.dat.post, is.na(Transitions))) + nrow(filter(behavior.dat.baseline, is.na(TransitionsBaseline))))/ (nrow(behavior.dat.post) + nrow(behavior.dat.baseline))
}
...
predM = mice(behavior.dat.post, seed = 1, maxit = 0)$predictorMatrix
{
  predM[, 
        c("Age")] = 0
  predM[c("JerkBaseline", "ShakeBaseline", "RubBaseline", "Hoof_rubBaseline", "EarBaseline", "DownBaseline", "Down_secBaseline", "UpBaseline", "Up_secBaseline", "OralBaseline", "Rum_secBaseline", "RankBaseline", "TransitionsBaseline")
        ,] = 0
  predM[, 
        c("JerkBaseline", "ShakeBaseline", "RubBaseline", "Hoof_rubBaseline", "EarBaseline", "DownBaseline", "Down_secBaseline", "UpBaseline", "Up_secBaseline", "OralBaseline", "Rum_secBaseline", "RankBaseline", "TransitionsBaseline",
          "Jerk", "Shake", "Rub", "Hoof_rub", "Ear", "Down", "Down_sec", "Up", "Up_sec", "Oral", "Rum_sec", "Rank", "Transitions")] = 0
  predM[c("JerkBaseline", "ShakeBaseline", "RubBaseline", "Hoof_rubBaseline", "EarBaseline", "DownBaseline", "Down_secBaseline", "UpBaseline", "Up_secBaseline", "OralBaseline", "Rum_secBaseline", "RankBaseline", "TransitionsBaseline"), 
  ...
  predM["Rank", "RankBaseline"] = 1
  predM["Transitions", "TransitionsBaseline"] = 1
  ...
  predM["RankBaseline", "Rank"] = 1
  predM["TransitionsBaseline", "Transitions"] = 1
...
#table(filter(behavior.dat.post, !is.na(Rank))$Treatment, filter(behavior.dat.post, !is.na(Rank))$Minute)
...
##lsmeans
lsmeans <- emmeans(model.ear, ~ Treatment|Minute, type = "response")
lsmeans2 <- emmeans(model.ear, ~ Treatment, type = "response")
lsmeans2
lsmeans3 <- emmeans(model.ear, ~ Minute|Treatment, type = "response")
lsmeans3

#means separation
multcomp::cld(lsmeans, alpha = .05)
multcomp::cld(lsmeans2, alpha = .05)
multcomp::cld(lsmeans3, alpha = .05)

confint(contrast(regrid(lsmeans), ratio = F, method = "pairwise"))
confint(contrast(regrid(lsmeans2), ratio = F, method = "pairwise"))
confint(contrast(regrid(lsmeans3), ratio = F, method = "pairwise"))

contrast(emmeans(model.ear, ~ Treatment), ratio = F, method = "pairwise")
...
chiSqValues.treatment <- lapply(analysis, function(x) {
  Anova(model.ear.pre$ana[[x]], test.statistic = "Chisq")[1,1]})
chiSqValues.treatment <- as.data.frame(chiSqValues.treatment)
miceadds::micombine.chisquare(chiSqValues.treatment, 2)
...
simulationOutput <- simulateResiduals(model.jerk$ana[[10]])
testDispersion(simulationOutput, plot = F, alternative = "greater")
testZeroInflation(simulationOutput, plot = F, alternative = "greater")
...
##lsmeans
lsmeans <- emmeans(model.jerk, ~ Treatment|Minute, type = "response")
lsmeans2 <- emmeans(model.jerk, ~ Treatment, type = "response")
lsmeans2
lsmeans3 <- emmeans(model.jerk, ~ Minute|Treatment, type = "response")
...
contrast(emmeans(model.jerk, ~ Treatment), ratio = F, method = "pairwise")
contrast(emmeans(model.jerk, ~ Treatment|Minute), ratio = F, method = "pairwise")
...
#make plot
{
  ggplot(data = predict.jerk, 
    ...
    #geom_text(label = "a", x = 60, y = 1.86+.25, color = "gray40", family = "Times New Roman", size = 5) + 
    #geom_text(label = "ab", x = 60, y = 1.26+.15, color = "gray40", family = "Times New Roman", size = 5) +
    #geom_text(label = "b", x = 60, y = 0.28-.15, color = "gray40", family = "Times New Roman", size = 5) +
...
simulationOutput <- simulateResiduals(model.shake$ana[[10]])
testDispersion(simulationOutput, plot = F, alternative = "greater")
testZeroInflation(simulationOutput, plot = F, alternative = "greater")
...
##lsmeans
lsmeans <- emmeans(model.shake, ~ Treatment|Hour, type = "response")
lsmeans2 <- emmeans(model.shake, ~ Treatment, type = "response")
lsmeans2
lsmeans3 <- emmeans(model.shake, ~ Hour|Treatment, type = "response")
...
contrast(emmeans(model.shake, ~ Treatment|Hour), ratio = F, method = "pairwise")
contrast(emmeans(model.shake, ~ Treatment), ratio = F, method = "pairwise")
...
#make plot
{
  ggplot(data = predict.shake, 
    ...
    labs(
      ...
      y = "Head shake rate, count 15-min\u207B\u00B9"
    ) +
    ...
    geom_text(label = "a", x = 2, y = 2.76+.2, color = "gray40", family = "Times New Roman", size = 5) + 
    geom_text(label = "ab", x = 2, y = 0.83+.2, color = "gray40", family = "Times New Roman", size = 5) +
    geom_text(label = "b", x = 2, y = 0.72-.2, color = "gray40", family = "Times New Roman", size = 5) +
    #geom_text(label = "Baseline", x = -.5, y = 0.05, color = "gray40", family = "Times New Roman", size = 4, hjust = 0, vjust = 0) 
...
simulationOutput <- simulateResiduals(model.oral$ana[[20]])
testDispersion(simulationOutput, plot = F, alternative = "greater")
testZeroInflation(simulationOutput, plot = F, alternative = "greater")
...
#pooled Chisq-tests
miceadds::micombine.chisquare(as.data.frame(lapply(analysis, function(x) {
  Anova(model.oral.h$ana[[x]], test.statistic = "Chisq")[1,1]})), 1)

miceadds::micombine.chisquare(as.data.frame(lapply(analysis, function(x) {
  Anova(model.oral$ana[[x]], test.statistic = "Chisq")[2,1]})), 2)

##lsmeans
lsmeans <- emmeans(model.oral, ~ Treatment, type = "response")
lsmeans
...
contrast(emmeans(model.oral, ~ Treatment, type = "response"), ratio = F, method = "pairwise")
...
simulationOutput <- simulateResiduals(model.stand$ana[[20]])
testDispersion(simulationOutput, plot = F, alternative = "greater")
testZeroInflation(simulationOutput, plot = F, alternative = "greater")
...
miceadds::micombine.chisquare(as.data.frame(lapply(analysis, function(x) {
  Anova(model.stand$ana[[x]], test.statistic = "Chisq")[2,1]})), 2)
...
##lsmeans
lsmeans <- emmeans(model.stand, ~ Treatment|Hour, type = "response")
lsmeans2 <- emmeans(model.stand, ~ Treatment, type = "response")
lsmeans2
lsmeans3 <- emmeans(model.stand, ~ Hour|Treatment, type = "response")
...
contrast(emmeans(model.stand, ~ Treatment|Hour, type = "response"), ratio = F, method = "pairwise")
contrast(emmeans(model.stand, ~ Treatment, type = "response"), ratio = F, method = "pairwise")
...
#make plot
{
  ggplot(
    ...
    ggsave("figure_standing_rate.png", width = 8, height = 5)
}
```
...
simulationOutput <- simulateResiduals(model.rum$ana[[1]])
testDispersion(simulationOutput, plot = F, alternative = "greater")
testZeroInflation(simulationOutput, plot = F, alternative = "greater")
...
##lsmeans
lsmeans <- emmeans(model.rum, ~ Treatment|Hour, type = "response")
lsmeans2 <- emmeans(model.rum, ~ Treatment, type = "response")
lsmeans2
...
contrast(emmeans(model.rum, ~ Treatment|Hour, type = "response"), ratio = F, method = "pairwise")
contrast(emmeans(model.rum, ~ Treatment, type = "response"), ratio = F, method = "pairwise")
...
chiSqValues.treatment <- lapply(analysis, function(x) {
  Anova(model.rum.pre$ana[[x]], test.statistic = "Chisq")[1,1]})
miceadds::micombine.chisquare(as.data.frame(chiSqValues.treatment), 2)
...
ggplot(data = predict.rum, 
  ...
  ggsave("figure_rumination_rate.png", width = 8, height = 5)
}
```

# Hoof rub  (nb2, summed over all times)
```{r}
#means
...
mean(as.data.frame(lapply(analysis, function(x) {
  means[["analyses"]][[x]][["LA-CD:80"]][["mean"]]})))

mean(as.data.frame(lapply(analysis, function(x) {
  means[["analyses"]][[x]][["LA-CD:80"]][["se"]]})))

mean(as.data.frame(lapply(analysis, function(x) {
  means[["analyses"]][[x]][["T-CD-T:260"]][["mean"]]})))

mean(as.data.frame(lapply(analysis, function(x) {
  means[["analyses"]][[x]][["T-CD-T:260"]][["se"]]})))
...
model.hoof <- 
  with(
    subset.hoof_rub,
    glmmTMB(
      Hoof_rub ~  scale(Hoof_rubBaseline) + Treatment + (1|Hutch), 
      family = nbinom2(),
      verbose = F, 
      REML = F
...
simulationOutput <- simulateResiduals(model.hoof$ana[[50]])
testDispersion(simulationOutput, plot = F, alternative = "greater")
testZeroInflation(simulationOutput, plot = F, alternative = "greater")

#pooled Chisq-tests
miceadds::micombine.chisquare(as.data.frame(lapply(analysis, function(x) {
  Anova(model.hoof$ana[[x]], test.statistic = "Chisq")[1,1]})), 1)

miceadds::micombine.chisquare(as.data.frame(lapply(analysis, function(x) {
  Anova(model.hoof$ana[[x]], test.statistic = "Chisq")[2,1]})), 2)

##lsmeans
lsmeans <- emmeans(model.hoof, ~ Treatment, type = "response")
lsmeans
...
contrast(emmeans(model.hoof, ~ Treatment, type = "response"), ratio = F, method = "pairwise")
...
model.hoof.pre <- 
  with(
    subset.hoof_rub,
    glmmTMB(
      Hoof_rubBaseline ~ Treatment + (1|Hutch), 
      family = nbinom2,
      verbose = F, 
      REML = F
    )
...
chiSqValues.treatment <- lapply(analysis, function(x) {
  Anova(model.hoof.pre$ana[[x]], test.statistic = "Chisq")[1,1]})
miceadds::micombine.chisquare(as.data.frame(chiSqValues.treatment), 2)
```

# Rubs (nb2, summed over all times)
```{r}
subset.rub <- 
  mice::complete(behavior.dat.post.imp, action = "long", include = T) %>%
...
model.rub <- 
  with(
    subset.rub,
    glmmTMB(
      Rub ~ scale(RubBaseline) + Treatment + (1|Hutch), 
      family = nbinom2(), 
      #ziformula = ~ 1,
      verbose = F, 
      REML = F
...
simulationOutput <- simulateResiduals(model.rub$ana[[10]])
testDispersion(simulationOutput, plot = F, alternative = "greater")
testZeroInflation(simulationOutput, plot = F, alternative = "greater")
...
#pooled Chisq-tests
miceadds::micombine.chisquare(as.data.frame(lapply(analysis, function(x) {
  Anova(model.rub$ana[[x]], test.statistic = "Chisq")[1,1]})), 1)

miceadds::micombine.chisquare(as.data.frame(lapply(analysis, function(x) {
  Anova(model.rub$ana[[x]], test.statistic = "Chisq")[2,1]})), 2)

##lsmeans
lsmeans <- emmeans(model.rub, ~ Treatment, type = "response")
lsmeans
...
contrast(emmeans(model.rub, ~ Treatment, type = "response"), ratio = F, method = "pairwise")
...
chiSqValues.treatment <- lapply(analysis, function(x) {
  Anova(model.rub.pre$ana[[x]], test.statistic = "Chisq")[1,1]})
miceadds::micombine.chisquare(as.data.frame(chiSqValues.treatment), 2)
```
...
subset.trans <- 
  mice::complete(behavior.dat.post.imp, action = "long", include = T) %>%
  dplyr::select(c(.imp, .id, ID, Breed, Age, Treatment, Hutch, Order, Transitions, TransitionsBaseline)) %>%
  group_by(.imp, ID, Breed, Age, Treatment, Hutch, Order) %>%
  summarise_all(funs(sum(.)))
...
model.trans <- 
  with(
    subset.trans,
    glmmTMB(
      Transitions ~ scale(TransitionsBaseline) + Treatment + (1|Hutch), 
      family = nbinom2(), 
      REML = F
    )
  )
...
simulationOutput <- simulateResiduals(model.trans$ana[[50]])
testDispersion(simulationOutput, plot = F, alternative = "greater")
testZeroInflation(simulationOutput, plot = F, alternative = "greater")
...
##lsmeans
lsmeans <- emmeans(model.trans, ~ Treatment, type = "response")
lsmeans
...
contrast(emmeans(model.trans, ~ Treatment, type = "response"), ratio = F, method = "pairwise")
...
model.trans.pre <- 
  with(
    subset.trans,
    glmmTMB(
      TransitionsBaseline ~ Treatment + (1|Hutch), 
      family = nbinom2,
      verbose = F, 
      REML = F
    )
...
chiSqValues.treatment <- lapply(analysis, function(x) {
  Anova(model.trans.pre$ana[[x]], test.statistic = "Chisq")[1,1]})
miceadds::micombine.chisquare(as.data.frame(chiSqValues.treatment), 2)
```
...
simulationOutput <- simulateResiduals(model.rum_lat$ana[[10]])
testDispersion(simulationOutput, plot = F, alternative = "greater")
testZeroInflation(simulationOutput, plot = F, alternative = "greater")
...
##lsmeans
lsmeans <- emmeans(model.rum_lat, ~ Treatment, type = "response")
lsmeans
...
contrast(emmeans(model.rum_lat, ~ Treatment, type = "response"), ratio = F, method = "pairwise")
```
...
simulationOutput <- simulateResiduals(model.lie_lat$ana[[10]])
testDispersion(simulationOutput, plot = F, alternative = "greater")
testZeroInflation(simulationOutput, plot = F, alternative = "greater")
...
##lsmeans
lsmeans <- emmeans(model.lie_lat, ~ Treatment, type = "response")
lsmeans
...
contrast(emmeans(model.lie_lat, ~ Treatment, type = "response"), ratio = F, method = "pairwise")
```
